...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(A_listIterPrevSetB_B, "A_listIterPrevSetB_B", LIST_B, STRING_B);
		...
		testThreeElementList(AB_listIterNextNextAddC_ABC, "AB_listIterNextNextAddC_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_listIterNextPrevAddC_CAB, "AB_listIterNextPrevAddC_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_listIterNextNextPrevAddC_ACB, "AB_listIterNextNextPrevAddC_ACB", LIST_ACB, STRING_ACB);
		...
		testTwoElementList(AB_listIterNextNextSetC_AC, "AB_listIterNextNextSetC_AC", LIST_AC, STRING_AC);
		testTwoElementList(AB_listIterNextPrevSetC_CB, "AB_listIterNextPrevSetC_CB", LIST_CB, STRING_CB);
		testTwoElementList(AB_listIterNextNextPrevSetC_AC, "AB_listIterNextNextPrevSetC_AC", LIST_AC, STRING_AC);
		...
		testThreeElementList(ABC_listIterNextPrevSetD_DBC, "ABC_listIterNextPrevSetD_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIterNextNextSetD_ADC, "ABC_listIterNextNextSetD_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterNextNextPrevSetD_ADC, "ABC_listIterNextNextPrevSetD_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIterNextNextNextSetD_ABD, "ABC_listIterNextNextNextSetD_ABD", LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_listIterNextNextNextPrevSetD_ABD, "ABC_listIterNextNextNextPrevSetD_ABD", LIST_ABD,STRING_ABD);
	...
	/**
	 * Scenario: [A] -> listIter remove(A) -> []
	 * 
	 * @return [] after listIter remove(A)
	 */
	private IndexedUnsortedList<Integer> A_listIterRemoveA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
		lit.remove();
	...
	/**
	 * Scenario: [A] -> list iter setB -> [B]
	 * 
	 * @return [B] after listIter setB
	 */
	...
	private Scenario<Integer> A_listIterPrevSetB_B = () -> A_listIterPrevSetB_B();
	...
	/**
	 * Scenario: [A,B] -> listiter add(C) -> [C,A,B]
	 * 
	 * @return [C,A,B] after listiter add(C)
	 */
	...
	/**
	 * Scenario: [A,B] -> listiter next, add(C) -> [A,C,B]
	 * 
	 * @return [A,C,B] after next, listiter add(C)
	 */
	...
	/**
	 * Scenario: [A,B] -> listiter next, next, add(C) -> [A,B,C]
	 * 
	 * @return [A,B,C] after listiter next, next, add(C)
	 */
	...
	private Scenario<Integer> AB_listIterNextNextAddC_ABC = () -> AB_listIterNextNextAddC_ABC();

	/**
	 * Scenario: [A,B] -> listiter previous, add(C) -> [C,A,B]
	 * 
	 * @return [C,A,B] after list iter previous, add(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterNextPrevAddC_CAB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
	...
	private Scenario<Integer> AB_listIterNextPrevAddC_CAB = () -> AB_listIterNextPrevAddC_CAB();

	/**
	 * Scenario: [A,B] -> listiter previous, add(C) -> [A,C,B]
	 * 
	 * @return [A,C,B] after list iter previous, add(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterNextNextPrevAddC_ACB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
	...
	private Scenario<Integer> AB_listIterNextNextPrevAddC_ACB = () -> AB_listIterNextNextPrevAddC_ACB();
	...
	/**
	 * Scenario: [A,B] -> listIter remove(A) -> [B]
	 * 
	 * @return [B] after listIter remove(A)
	 */
	...
	/**
	 * Scenario: [A,B] -> listIter remove(B) -> [A]
	 * 
	 * @return [A] after listIter remove(B)
	 */
	...
	/**
	 * Scenario: [A,B] -> list iter next, set(C) -> [C,B]
	 * 
	 * @return [C,B] after list iter next, set(C)
	 */
	...
	/**
	 * Scenario: [A,B] -> list iter next, prev, set(C) -> [C,B]
	 * 
	 * @return [A,C] after list iter next, prev set(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterNextPrevSetC_CB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
	...
	private Scenario<Integer> AB_listIterNextPrevSetC_CB = () -> AB_listIterNextPrevSetC_CB();

	/**
	 * Scenario: [A,B] -> list iter next, next, set(C) -> [A,C]
	 * 
	 * @return [A,C] after list iter next, next set(C)
	 */
	...
	private Scenario<Integer> AB_listIterNextNextSetC_AC = () -> AB_listIterNextNextSetC_AC();

	/**
	 * Scenario: [A,B] -> list iter next, next, previous set(C) -> [A,C]
	 * 
	 * @return [A,C] after list iter next, next set(C)
	 */
	private IndexedUnsortedList<Integer> AB_listIterNextNextPrevSetC_AC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
	...
	private Scenario<Integer> AB_listIterNextNextPrevSetC_AC = () -> AB_listIterNextNextPrevSetC_AC();
	...
	/**
	 * Scenario: [A,B,C] -> listIter remove(A) -> [B,C]
	 * 
	 * @return [B,C] after listIter remove remove(A)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> listIter remove(B) -> [A,C]
	 * 
	 * @return [A,C] after listIter remove remove(B)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> listIter remove(C) -> [A,B]
	 * 
	 * @return [A,B] after listIter remove remove(C)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> list iter next, set(D) -> [D,B,C]
	 * 
	 * @return [D,B,C] after list iter next, set(D)
	 */
	...
	/**
	 * Scenario: [A,B,C] -> list iter next, prev, set(D) -> [D,B,C]
	 * 
	 * @return [D,B,C] after list iter next, prev, set(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterNextPrevSetD_DBC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		ListIterator<Integer> it = list.listIterator();
	...
	private Scenario<Integer> ABC_listIterNextPrevSetD_DBC = () -> ABC_listIterNextPrevSetD_DBC();

	/**
	 * Scenario: [A,B,C] -> list iter next, next, set(D) -> [A,D,C]
	 * 
	 * @return [A,D,C] after list iter next, next, set(D)
	 */
	...
	private Scenario<Integer> ABC_listIterNextNextSetD_ADC = () -> ABC_listIterNextNextSetD_ADC();

	/**
	 * Scenario: [A,B,C] -> list iter next, next, prev, set(D) -> [A,D,C]
	 * 
	 * @return [A,D,C] after list iter next, next, prev, set(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterNextNextPrevSetD_ADC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		ListIterator<Integer> it = list.listIterator();
	...
	private Scenario<Integer> ABC_listIterNextNextPrevSetD_ADC = () -> ABC_listIterNextNextPrevSetD_ADC();

	/**
	 * Scenario: [A,B,C] -> list iter next, next, next, set(D) -> [A,B,D]
	 * 
	 * @return [A,B,D] after list iter next, next, next, set(D)
	 */
	...
	private Scenario<Integer> ABC_listIterNextNextNextSetD_ABD = () -> ABC_listIterNextNextNextSetD_ABD();

	/**
	 * Scenario: [A,B,C] -> list iter next, next, next, prev, set(D) -> [A,B,D]
	 * 
	 * @return [A,B,D] after list iter next, next, next, prev, set(D)
	 */
	private IndexedUnsortedList<Integer> ABC_listIterNextNextNextPrevSetD_ABD() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		ListIterator<Integer> it = list.listIterator();
	...
	private Scenario<Integer> ABC_listIterNextNextNextPrevSetD_ABD = () -> ABC_listIterNextNextNextPrevSetD_ABD();
